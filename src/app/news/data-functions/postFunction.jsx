...
export const postUtils = {
    like: async (id, postID) => {
        const result = await checkUserExist('/post/like', {id: id, postID: postID});
        if (result) {
        ...
        if (!result) {
            checkUserExist('/post/like/new', {id: id, postID: postID});
            return true
        }
    },
    ...
    postComment: async (postID, data) => {
        const result = await checkUserExist('/post/comment', {postID: postID, data: data});
    ...
    getPostById: async (postID) => {
        const result = await checkUserExist('/post/getById', {postID: postID});
        return result
    },
    newPost: async (data) => {
    ...
    getAllPostsOfUser: async (userID) => {
        const result = checkUserExist('/post/getAllPostsOfUser', {userID: userID});
        return result
    },
